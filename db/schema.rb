...
ActiveRecord::Schema[7.2].define(version: 2025_04_15_182527) do
  ...
  create_table "user_rewards", force: :cascade do |t|
    ...
    t.index ["reward_id", "question_id"], name: "index_user_rewards_on_reward_id_and_question_id", unique: true
  ...
  add_foreign_key "user_rewards", "questions"
